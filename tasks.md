...
- [ ] 接入 macOS LocalAuthentication，支援 Touch ID 可用時解鎖。
...
- [ ] 評估是否導入 macOS Keychain 儲存受保護的 key material。
...
- [ ] 在 README 補上 macOS 截圖防護驗證矩陣與限制。

## macOS 建置

- [ ] 建立 macOS release package，處理 signing、notarization、DMG 或 zip。
- [ ] 建立 GitHub Actions 或其他 CI，跑 Go test、frontend build、npm audit、macOS build。
