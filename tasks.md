...
- [ ] 在 macOS 實機驗證 Wails `ContentProtection` 是否阻擋 Screenshot、QuickTime、螢幕分享。（已建立 README 驗證矩陣，待實機執行）
...
- [ ] 處理 macOS Developer ID signing、notarization、stapling。（已建立 script 入口；目前無法簽署，待 Developer ID 憑證與 Apple notarization 憑證）
